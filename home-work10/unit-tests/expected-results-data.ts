...
export const expectedResults = {
    ...
    stopEngine: 'The Porsche Taycan car is turned off',
    stopEngineThatAlreadyStopped: 'The Porsche Taycan car is already off',
    pickUpSpeedInfo: 'The Porsche Taycan car is picking up speed',
    canNotPickUpSpeed: 'Start the engine and make sure the battery is charged!',
